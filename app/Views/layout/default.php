    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, <?= userLogin()->username ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?= site_url('logout') ?>" class="dropdown-item has-icon text-danger" id="logout" data-confirm="Logout|Yakin Deck Mau Keluar Aplikasi ?" data-confirm-yes="returnLogout()">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; <?= date('Y') ?> <div class="bullet"></div> Design By <a href="https://nauval.in/">Boby Agus Saputro</a>
        </div>
